...
const menu = async (m, { conn, bot }) => {
    ...
    const txt = `
*مرحبا بك في نظام ✨️𝐊𝐀𝐈𝐓𝐎 𝐊𝐈𝐃 𝐁𝐎𝐓✨️ استمتع ب البوت المطور : +22242203253 اذا واجهتك مشكلة تواصل معه*
╭━━━〔 ✦𝐊𝐀𝐈𝐓𝐎 𝐊𝐈𝐃 𝐁𝐎𝐓✦ 〕━━━╮
...
menu.before = async (m, { conn, bot }) => {
    ...
    if (!cmds?.length) {
        await conn.sendMessage(m.chat, { text: '*لاشيئ هنا استمتع ب البوت*' }, { quoted: reply_status });
        return true;
    }
